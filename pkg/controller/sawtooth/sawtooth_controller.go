...
// Reconcile reads that state of the cluster for a Sawtooth object and makes changes based on the state read
// and what is in the Sawtooth.Spec
...
func newPodForCR(cr *sawtoothv1alpha1.Sawtooth) *corev1.Pod {
